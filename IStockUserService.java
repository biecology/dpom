...
public interface IStockUserService extends IService<StockUser> {
    ...
    boolean checkInternalCode(String internalCode);

  
    boolean checkUserExist(String account, String areaCode,String tid);

    int addTgFriend(String curTgId, String friTgId);

    int delTgFriend(String curTgId, String friTgId);

    int delAllTgFriendByCurId(String curTgId);

    void syncTgFriend(String curTgId, String friendList);
}
